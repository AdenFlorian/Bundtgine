...
const std::vector<Vertex> squareVertices2 = {
	{ { -0.5f, -0.5f }, { 1.0f, 0.3f, 0.0f }, { 0.0f, 0.0f } },
	{ { 0.5f, -0.5f }, { 0.9f, 0.7f, 0.6f }, { 1.0f, 0.0f } },
	{ { 0.5f, 0.5f }, { 0.7f, 0.0f, 1.0f }, { 1.0f, 1.0f } },
	{ { -0.5f, 0.5f }, { 1.0f, 0.3f, 0.7f }, { 0.0f, 1.0f } }
};
...
void HelloTriangleApplication::createImageView(VkImage image, VkFormat format, VkImageView* imageView)
{
